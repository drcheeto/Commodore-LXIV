...
/mob/living/simple_animal/bot/buttbot
	name = "buttbot"
	desc = "It's a robotic butt. Are you dense or something?? He looks shiny and new, like he is superior to Hippie's buttbots WHICH ARE STILL CODED AS MACHINERY WHAT THE FUCK."
...
/mob/living/simple_animal/bot/buttbot/bot_process()
	if (!..())
		return
